...
@app.route('/success/<string:score>')
def success(score):
    res=""
...
def submit():
    ...
    if request.method=='POST':
        ...
        input_str = request.form['science']

        co = cohere.Client('Fblw8IQtY3tDKoossTsaJrOBPa9TSa99lzAoi5hi') # This is your trial API key
        ...
        prediction_flair = raw_print_statement_flair[0].split(": ")[-1][1:-1].lower()
        prediction_flair = "                                            Flair: " + str(prediction_flair.title())

        
        pos_or_neg = ('This was a {} experience'.format(prediction.upper()))
        final = pos_or_neg + prediction_flair

    res=""
    return redirect(url_for('success',score=final))
